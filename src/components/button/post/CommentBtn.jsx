...
const CommentBtn = ({ number }) => {
    return (
        <button className="flex gap-1.5 p-2.5 w-fit text-sm font-medium text-center items-center text-white rounded-lg hover:bg-comment-highlight transition duration-200">
