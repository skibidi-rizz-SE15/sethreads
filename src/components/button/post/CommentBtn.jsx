...
const CommentBtn = ({ number }) => {
    return (
        <button className="flex overflow-hidden gap-1 self-end px-2.5 py-2.5 mt-2 mr-6 w-fit text-sm font-medium tracking-normal leading-5 text-center items-center text-white whitespace-nowrap rounded-lg hover:bg-comment-highlight transition duration-200">
