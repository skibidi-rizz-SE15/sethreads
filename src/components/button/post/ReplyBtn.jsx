...
const ReplyBtn = ({ className="" }) => {
    const style = `flex gap-1 p-2 mt-2 w-fit text-sm font-medium tracking-normal leading-5 text-center items-center text-white whitespace-nowrap rounded-lg hover:bg-comment-highlight ${className}`;
    return (
