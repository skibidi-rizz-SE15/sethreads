...
function Sidebar() {
  ...
  return (
    <nav className="flex overflow-hidden z-10 flex-col items-start px-3 pt-10 max-w-full text-base tracking-wide text-white whitespace-nowrap rounded-none border-r border-r-yellow-600 bg-eerie-black h-full">
      <div className="flex overflow-hidden gap-2 px-2.5 py-2.5 w-full font-bold rounded-lg bg-zinc-600 max-md:px-1">
