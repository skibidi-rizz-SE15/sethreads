...
function Sidebar() {
  ...
  return (
    <nav className="flex overflow-hidden z-10 flex-col items-start px-3 pt-10 max-w-full text-base tracking-wide text-white whitespace-nowrap rounded-none border-t border-r border-yellow-600 bg-neutral-800 pb-[608px] w-[303px] max-md:pb-24">
