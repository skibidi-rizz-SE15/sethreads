    ...
    return (
        <div className="flex flex-col w-full gap-y-4">
            ...
            <div className="flex w-full justify-center items-center">
                <button className="w-[8rem] ml-auto bg-software-orange hover:bg-software-orange-hover text-white font-bold py-2 px-2 rounded-lg" onClick={ toggleEditCourses }>{ isEditCourses ? "Done" : "Edit Courses"}</button>            
            </div>
        </div>
    );
}
