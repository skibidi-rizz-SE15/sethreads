...
function ProfileCard({ student, onclick }) {
  return (
    <div className='bg-eerie-black border border-software-orange hover:bg-steadfast h-[10rem] p-4 rounded-lg shadow-md grid grid-cols-[auto_1fr] gap-4 w-full items-center' onClick={onclick}>
