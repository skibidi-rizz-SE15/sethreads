...
function HighlightSection() {
    ...
    return (
        <section>
          <div className="flex gap-4 self-start mt-10 text-2xl font-medium text-white whitespace-nowrap max-md:mt-10">   
          ...
          <div className="mt-10 ml-6 max-w-full w-[1037px] max-md:mt-10">   
