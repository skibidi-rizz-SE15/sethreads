...
function HighlightCard({ title, comments, taName }) {
  return (
    <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
      <div className="flex overflow-hidden flex-col items-start py-3 pr-16 pl-2.5 mx-auto w-full text-xs text-white rounded-2xl border border-solid bg-neutral-800 border-neutral-700 max-md:pr-5 max-md:mt-5">
