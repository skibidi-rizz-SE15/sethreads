...
const HighlightCard = ({ title, taName, year, comments, className="" }) => {
  return (
    <div className={`flex overflow-hidden flex-col gap-2 items-start py-3 px-2.5 text-xs text-white rounded-2xl border border-solid bg-neutral-800 hover:bg-general-highlight border-neutral-700 ${className}`}>
