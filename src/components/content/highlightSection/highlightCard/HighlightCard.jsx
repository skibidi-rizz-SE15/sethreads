...
const HighlightCard = ({ title, taName, className="" }) => {
  const style = `flex overflow-hidden flex-col gap-2 items-start py-3 px-2.5 text-xs text-white rounded-2xl border border-solid bg-neutral-800 hover:bg-general-highlight border-neutral-700 max-md:ml-0 max-md:w-full ${className}`;
  return (
    <div className={style}>
